...
INSERT INTO `domande` VALUES (1,'Quali sono le parole chiave più rilevanti per il nostro settore?',1,'2025-07-08 10:12:03','root@localhost'),(2,'Come possiamo migliorare il posizionamento sui motori di ricerca?',1,'2025-08-28 12:52:50','root@localhost'),(3,'Qual è il ROI delle nostre campagne SEM attuali?',2,'2025-07-08 10:12:03','root@localhost'),(4,'Come possiamo ottimizzare le offerte CPC per massimizzare le conversioni?',2,'2025-07-08 10:12:03','root@localhost'),(5,'Quale piattaforma di email marketing consigliate?',3,'2025-07-08 10:12:03','root@localhost'),(6,'Come possiamo segmentare meglio la nostra lista email?',3,'2025-07-08 10:12:03','root@localhost'),(7,'Quali sono le strategie più efficaci per la lead generation?',4,'2025-07-08 10:12:03','root@localhost'),(8,'Come possiamo qualificati i lead in ingresso?',4,'2025-07-08 10:12:03','root@localhost'),(9,'Quali sono i termini standard per i nostri contratti B2B?',5,'2025-07-08 10:12:03','root@localhost'),(10,'Qual è il nostro tasso di successo nella chiusura dei contratti?',5,'2025-07-08 10:12:03','root@localhost'),(11,'Come monitoriamo l\'efficienza della flotta?',6,'2025-07-08 10:12:03','root@localhost'),(12,'Quali sono i costi di manutenzione della nostra flotta?',6,'2025-07-08 10:12:03','root@localhost'),(13,'Come ottimizziamo i percorsi di consegna?',7,'2025-07-08 10:12:03','root@localhost'),(14,'Quali software usiamo per la pianificazione dei percorsi?',7,'2025-07-08 10:12:03','root@localhost'),(15,'Come gestiamo l\'inventario per evitare esaurimento scorte?',8,'2025-07-08 10:12:03','root@localhost'),(16,'Qual è la nostra rotazione di magazzino media?',8,'2025-07-08 10:12:03','root@localhost'),(17,'Quali standard di qualità adottiamo per i prodotti in ingresso?',9,'2025-07-08 10:12:03','root@localhost'),(18,'Come gestiamo i resi per difetti di qualità?',9,'2025-07-08 10:12:03','root@localhost'),(19,'Qual è il processo di fatturazione per i nuovi clienti?',10,'2025-07-08 10:12:03','root@localhost'),(20,'Come gestiamo i crediti inesigibili?',10,'2025-07-08 10:12:03','root@localhost'),(21,'Quali sono le procedure per la riconciliazione bancaria?',11,'2025-07-08 10:12:03','root@localhost'),(22,'Come identifichiamo le discrepanze nei conti?',11,'2025-07-08 10:12:03','root@localhost'),(23,'Quali sono le scadenze fiscali principali per quest\'anno?',12,'2025-07-08 10:12:03','root@localhost'),(24,'Come possiamo ridurre l\'onere fiscale legalmente?',12,'2025-07-08 10:12:03','root@localhost'),(25,'Come calcoliamo il costo di produzione per unità?',13,'2025-07-08 10:12:03','root@localhost'),(26,'Quali sono i maggiori fattori di costo operativi?',13,'2025-07-08 10:12:03','root@localhost'),(27,'Quali sono le migliori pratiche per condurre un colloquio?',14,'2025-07-08 10:12:03','root@localhost'),(28,'Come valutiamo le competenze tecniche dei candidati?',14,'2025-07-08 10:12:03','root@localhost'),(29,'Qual è il processo di onboarding per i nuovi assunti?',15,'2025-07-08 10:12:03','root@localhost'),(30,'Come misuriamo l\'efficacia dell\'onboarding?',15,'2025-07-08 10:12:03','root@localhost'),(31,'Quali corsi di aggiornamento sono obbligatori per il nostro personale?',16,'2025-07-08 10:12:03','root@localhost'),(32,'Come valuti l\'impatto della formazione sulla produttività? ',16,'2025-07-28 10:35:56','root@localhost'),(33,'Quali certificazioni IT sono richieste per il ruolo X?',17,'2025-07-08 10:12:03','root@localhost'),(34,'Offriamo incentivi per l\'ottenimento di certificazioni?',17,'2025-07-08 10:12:03','root@localhost'),(35,'Quali pattern di architettura software adottiamo?',18,'2025-07-08 10:12:03','root@localhost'),(36,'Come garantiamo la scalabilità delle nostre applicazioni?',18,'2025-07-08 10:12:03','root@localhost'),(37,'Quali strumenti usiamo per il debug del codice?',19,'2025-07-08 10:12:03','root@localhost'),(38,'Come gestiamo i bug critici in produzione?',19,'2025-07-08 10:12:03','root@localhost'),(39,'Qual è il SLA per le richieste di help desk?',20,'2025-07-08 10:12:03','root@localhost'),(40,'Come misuriamo la soddisfazione degli utenti del supporto tecnico?',20,'2025-07-08 10:12:03','root@localhost'),(41,'Qual è il processo di escalation per gli incidenti di livello 1?',21,'2025-07-08 10:12:03','root@localhost'),(42,'Come documentiamo e analizziamo gli incidenti passati?',21,'2025-07-08 10:12:03','root@localhost'),(49,'Domanda 1 Driver 1',1,'2025-08-28 13:44:39','root@localhost'),(50,'Domanda 1 Driver 2',2,'2025-08-28 13:44:39','root@localhost'),(51,'Domanda 2 Driver 1',1,'2025-08-28 13:44:39','root@localhost'),(52,'Domanda 1 Driver 3',3,'2025-08-28 13:44:39','root@localhost'),(53,'Domanda 2 Driver 2',2,'2025-08-28 13:44:39','root@localhost');
...
INSERT INTO `domande_questionario` VALUES (4,1),(5,1),(2,2),(3,2),(2,3),(3,3),(2,4),(3,5),(4,16),(5,17),(4,36),(3,50),(2,51),(3,52);
...
INSERT INTO `gruppo_risposta` VALUES (1,'Si Positivo','system','2025-07-28 16:18:12'),(2,'Tutti Parzialmente','system','2025-07-28 16:18:12'),(3,'SI Negativo','system','2025-07-28 16:18:12'),(4,'Si Parzialmente','system','2025-07-28 16:18:12');
...
INSERT INTO `questionario` VALUES (1,'q1','2025-09-02 15:48:50','Utente di test',NULL,NULL),(2,'q4','2025-09-02 15:53:26','Utente di test',NULL,NULL),(3,'q2','2025-09-08 09:25:26','Utente di test',NULL,NULL),(4,'q3','2025-09-08 13:30:38','Utente di test',NULL,NULL),(5,'q5','2025-09-08 13:46:09','Utente di test',NULL,NULL);
...
CREATE TABLE `risposta` (
  ...
  KEY `fk_id_gruppo_risposta` (`ID_GRUPPO_RISPOSTA`),
  CONSTRAINT `fk_id_gruppo_risposta` FOREIGN KEY (`ID_GRUPPO_RISPOSTA`) REFERENCES `gruppo_risposta` (`ID_GRUPPO_RISPOSTA`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabella per la gestione delle risposte associate ai gruppi di risposte.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `risposta` VALUES (14,'SI',1,NULL,'2025-07-28 16:31:18',1.00),(15,'NO',1,NULL,'2025-07-28 16:31:18',0.00),(16,'Non noto',1,NULL,'2025-07-28 16:31:18',0.00),(17,'N/A',1,NULL,'2025-07-28 16:31:18',1.00),(18,'Tutti',2,NULL,'2025-07-28 16:31:18',1.00),(19,'Parzialmente',2,NULL,'2025-07-28 16:31:18',0.50),(20,'Nessuno',2,NULL,'2025-07-28 16:31:18',0.00),(21,'N/A',2,NULL,'2025-07-28 16:31:18',1.00),(22,'Non Noto',2,NULL,'2025-07-28 16:31:18',0.00),(23,'SI',3,NULL,'2025-07-28 16:33:23',0.00),(24,'NO',3,NULL,'2025-07-28 16:33:23',1.00),(25,'Non Noto',3,NULL,'2025-07-28 16:33:23',0.00),(26,'N/A',3,NULL,'2025-07-28 16:33:23',1.00),(27,'SI',4,NULL,'2025-07-28 16:34:55',1.00),(28,'NO',4,NULL,'2025-07-28 16:34:55',0.00),(29,'Parzialmente',4,NULL,'2025-07-28 16:34:55',0.50),(30,'Non noto',4,NULL,'2025-07-28 16:34:55',0.00),(31,'N/A',4,NULL,'2025-07-28 16:34:55',1.00);
...
INSERT INTO `t_funzionalita` VALUES (1,1,NULL,'Gestione Anagrafiche','Gestione Anagrafiche','fa-solid fa-cog','#',1,'_self',NULL,1),(2,0,1,'Ambito','Ambito','fa-solid fa-boxes','/ambito',2,'_self',NULL,1),(3,0,1,'Categoria','Categoria','fa-solid fa-tags','/categoria',3,'_self',NULL,1),(4,0,1,'Driver','Driver','fa-solid fa-road','/driver',4,'_self',NULL,1),(5,0,1,'Domanda','Domanda','fa-solid fa-question','/domanda',5,'_self',NULL,1),(9,0,NULL,'Menu Analista','Menu Analista','fa-solid fa-chart-line','#',10,'_self',NULL,1),(10,0,9,'Menu 10','Menu 10','fa-solid fa-circle-1','/menu10',11,'_self',NULL,1),(11,0,9,'Menu 11','Menu 11','fa-solid fa-circle-2','/menu11',12,'_self',NULL,1),(12,0,9,'Menu 12','Menu 12','fa-solid fa-circle-3','/menu12',13,'_self',NULL,1),(19,0,1,'Gruppi Risposte','Gruppi Risposte','fas fa-reply-all','/gruppo_risposta',15,'_self',NULL,1),(41,0,1,'Caricamento Domande','Caricamento Domande','fas fa-upload','/caricamento_domande',16,'_self',NULL,1),(42,0,NULL,'Menu 10','Menu Dieci','fas fa-list','/menu10',20,'_self',NULL,1),(43,0,NULL,'Menu 11','Menu Undici','fas fa-chart-line','/menu11',21,'_self',NULL,1),(44,0,NULL,'Menu 12','Menu Dodici','fas fa-table','/menu12',22,'_self',NULL,1),(45,0,1,'Log upload','Log upload','fa-solid fa-clipboard-check','/caricamenti_log',17,'_self',NULL,1),(46,0,NULL,'Gestione Progetti','Gestione Progetti','fa-solid fa-rocket','#',2,'_self',NULL,1),(47,0,46,'Nuovo Progetto','Nuovo Progetto','fa-solid fa-clone','/progetti',1,'_self',NULL,1),(48,0,46,'Assegna Analisti','Assegna Analisti','fa-solid fa-user-group','/assegna_analisti',2,'_self',NULL,1),(49,0,46,'Crea Questionario','Crea Questionario','fa-solid fa-user-group','/crea_questionario',3,'_self',NULL,1);
...
-- Dump completed on 2025-09-09 11:02:09
