# Classi/ClasseProgettoQuestionario/Controller_progetto_questionario.py
# -*- coding: utf-8 -*-
...
class ProgettoQuestionario(Base):
    ...
    # Relazioni con ProgettoQuestionarioDomanda (usando stringa per evitare import circolare)
