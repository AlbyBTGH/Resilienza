...
import sys
import logging
# ⭐ MODIFICA: Aggiunto render_template
...
# ======================================================================
# ⭐ NUOVA ROTTA: Pagina Dashboard Grafici (GET)
# ======================================================================
@punteggio_controller.route(
    "/report/dashboard/<int:id_progetto_questionario>", 
    methods=['GET']
)
def dashboard_questionario_page(id_progetto_questionario):
    """
    Pagina dedicata alla visualizzazione dei grafici e report di un questionario specifico.
    """
...
# ======================================================================
# ROTTA: Dati Grafico Radar Punteggio (GET)
