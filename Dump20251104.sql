...
INSERT INTO `domande_questionario` VALUES (1,1),(4,1),(5,1),(6,1),(7,1),(2,2),(3,2),(1,3),(2,3),(3,3),(2,4),(7,4),(3,5),(6,5),(7,6),(6,7),(6,9),(6,11),(6,12),(6,13),(6,14),(4,16),(6,16),(5,17),(6,21),(4,36),(3,50),(2,51),(3,52);
...
INSERT INTO `progetto_questionario_domanda` VALUES (3,6,2,1),(4,6,3,1),(5,6,5,1),(6,6,50,1),(7,6,52,1),(10,8,2,2),(11,8,3,1),(12,8,4,2),(13,8,51,1);
...
INSERT INTO `questionario` VALUES (1,'q1','2025-09-02 15:48:50','Utente di test','2025-10-15 10:38:08','configuratore@example.com'),(2,'q4','2025-09-02 15:53:26','Utente di test',NULL,NULL),(3,'q2','2025-09-08 09:25:26','Utente di test',NULL,NULL),(4,'q3','2025-09-08 13:30:38','Utente di test',NULL,NULL),(5,'q5','2025-09-08 13:46:09','Utente di test',NULL,NULL),(6,'q6','2025-09-09 10:09:49','Utente di test','2025-10-20 13:44:55','configuratore@example.com'),(7,'quest100','2025-10-15 09:16:26','Utente di test','2025-10-15 09:32:30','configuratore@example.com');
...
--
-- Table structure for table `questionario_punteggio`
--

DROP TABLE IF EXISTS `questionario_punteggio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `questionario_punteggio` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `ID_PROGETTO_QUESTIONARIO` int NOT NULL,
  `PUNTEGGIO_TOTALE` decimal(10,2) NOT NULL,
  `DESCR_PROGETTO` varchar(200) NOT NULL,
  `DESCR_CLIENTE` varchar(255) NOT NULL,
  `MODIFICATO_DA` varchar(100) DEFAULT NULL,
  `DATA_ULTIMA_MODIFICA` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`),
  KEY `fk_qp_pq` (`ID_PROGETTO_QUESTIONARIO`),
  CONSTRAINT `fk_qp_pq` FOREIGN KEY (`ID_PROGETTO_QUESTIONARIO`) REFERENCES `progetto_questionario` (`ID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `questionario_punteggio`
--

LOCK TABLES `questionario_punteggio` WRITE;
/*!40000 ALTER TABLE `questionario_punteggio` DISABLE KEYS */;
/*!40000 ALTER TABLE `questionario_punteggio` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `risposta_cliente` VALUES (1,3,18,'2025-11-04 16:19:27','configuratore@example.com','2025-11-04 16:40:11'),(2,5,17,'2025-11-04 16:40:22','configuratore@example.com','2025-11-04 16:40:22'),(3,10,19,'2025-11-04 16:51:53','configuratore@example.com','2025-11-04 16:51:53');
...
-- Dump completed on 2025-11-04 17:44:57
