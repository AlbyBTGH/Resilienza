...
INSERT INTO `cliente` VALUES (1,'Cliente1','12345678901',NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-02 14:02:19',NULL),(2,'Cliente2','11111111112',NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-29 16:17:23',NULL);
...
INSERT INTO `domande_questionario` VALUES (1,1),(4,1),(5,1),(6,1),(7,1),(2,2),(3,2),(1,3),(2,3),(3,3),(2,4),(7,4),(3,5),(6,5),(7,6),(6,7),(6,9),(6,11),(6,12),(6,13),(6,14),(3,15),(3,16),(4,16),(6,16),(5,17),(6,21),(4,36),(3,50),(2,51),(3,52);
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabella per la gestione dei gruppi di risposte.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `gruppo_risposta_risposta` VALUES (1,14),(4,15),(2,16),(1,17),(1,18),(2,18),(2,19),(2,20),(3,20),(4,35),(2,38);
...
INSERT INTO `progetto` VALUES (12,'proj2','2025-01-11','2025-12-31',1,5,1,NULL,'configuratore@example.com','2025-10-14 10:56:58'),(14,'proj3','2025-10-10','2025-12-31',2,10,1,'ugo','configuratore@example.com','2025-10-14 13:32:13');
...
INSERT INTO `progetto_questionario` VALUES (6,12,3,'2025-10-17 16:30:14'),(8,14,2,'2025-10-21 17:54:08');
...
INSERT INTO `progetto_questionario_domanda` VALUES (3,6,2,1),(4,6,3,1),(5,6,5,1),(6,6,50,1),(7,6,52,1),(10,8,2,2),(11,8,3,1),(12,8,4,2),(13,8,51,1),(14,6,15,1),(15,6,16,1);
...
INSERT INTO `progetto_questionario_punteggio` VALUES (21,14,2,1,8,1,3.00,'2025-11-07 17:18:48'),(37,12,3,1,6,1,5.00,'2025-11-10 12:07:07'),(38,12,3,1,6,7,1.00,'2025-11-10 12:07:07'),(39,12,3,1,6,4,2.00,'2025-11-10 12:07:07');
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabella per la gestione delle risposte associate ai gruppi di risposte.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `risposta_cliente` VALUES (1,3,18,'2025-11-04 16:19:27','configuratore@example.com','2025-11-04 16:40:11'),(2,5,17,'2025-11-04 16:40:22','configuratore@example.com','2025-11-04 16:40:22'),(3,10,19,'2025-11-04 16:51:53','configuratore@example.com','2025-11-04 16:51:53'),(4,6,17,'2025-11-05 16:26:04','configuratore@example.com','2025-11-05 16:26:04'),(5,4,17,'2025-11-06 17:46:46','configuratore@example.com','2025-11-06 17:46:46'),(6,7,17,'2025-11-06 17:46:46','configuratore@example.com','2025-11-06 17:46:46'),(7,11,17,'2025-11-07 15:14:54','configuratore@example.com','2025-11-07 15:14:54'),(8,12,19,'2025-11-07 15:15:00','configuratore@example.com','2025-11-07 15:15:00'),(10,13,17,'2025-11-07 15:22:35','configuratore@example.com','2025-11-07 15:22:35'),(11,14,17,'2025-11-10 10:59:31','configuratore@example.com','2025-11-10 11:00:14'),(12,15,17,'2025-11-10 10:59:31','configuratore@example.com','2025-11-10 11:00:14');
...
-- Dump completed on 2025-11-10 16:49:11
